...
export const sendOrderConfirmationEmail = async (options: IOptions) => {
    ...
    <div style="padding: 20px; color: #333;">
        ...
        <tbody>
          ${orderDetails.items.map((item) => `
            <tr>
              ...
              <td style="text-align: right; padding: 8px; border-bottom: 1px solid #eee;">Rs. ${item.product.price.toFixed(2)}</td>
            </tr>
          `).join('')}
        </tbody>
      </table>
      ...
      <p style="margin-top: 20px; text-align: center; color: #666;">
        Thank you for purchasing from us! We appreciate your business.
      </p>
