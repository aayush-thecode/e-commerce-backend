...
exports.remove = exports.update = exports.getProductById = exports.getAll = exports.create = void 0;
...
// get product by id
exports.getProductById = (0, asyncHandler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.update = (0, asyncHandler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield product_model_1.default.findByIdAndUpdate(id, { name, price, description }, { new: true });
    if (!product) {
        throw new errorhandler_middleware_1.CustomError('', 404);
    }
    if (categoryId) {
        const category = yield category_model_1.default.findById(categoryId);
        if (!category) {
