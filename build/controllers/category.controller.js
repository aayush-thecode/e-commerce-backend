...
exports.deleteCategoryById = exports.UpdateProduct = exports.getCategoryById = exports.getAllCategory = exports.create = void 0;
...
//get category by id 
exports.getCategoryById = (0, asyncHandler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!categoryId) {
        throw new errorhandler_middleware_1.CustomError('category not found!', 400);
    }
    res.status(201).json({
        status: 'success',
        success: true,
...
exports.UpdateProduct = (0, asyncHandler_utils_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!productId) {
        throw new errorhandler_middleware_1.CustomError('category is required', 400);
    }
    const { name, description } = req.body;
    const category = yield category_model_1.default.findByIdAndUpdate(productId, {
        name,
        description
    }, { new: true });
